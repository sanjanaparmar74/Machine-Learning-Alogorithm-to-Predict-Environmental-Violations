...
user_path = os.path.join('/data/groups/epa1/', andrew_id+ '_work/mlpolicylab_fall21_epa1/pipeline_code/triage_build')
...
# loading config file
with open('triage_build_config.yaml', 'r') as fin:
